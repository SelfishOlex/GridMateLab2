...
namespace MyProject
{
    ...
    {
    public:
        AZ_RTTI(MyProjectModule, "{330AACA3-6D0A-4933-B887-D4EB7B78D878}", CryHooksModule);
...
AZ_DECLARE_MODULE_CLASS(MyProject_3d891812567a43af9c0f95303def50ff, MyProject::MyProjectModule)
